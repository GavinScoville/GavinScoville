...
A peer-reviewed study investigating whether recycled coal fly ash can be used as a substrate for concentrated solar power. Under Dr. Glosser, I played a key role in building the data visualizations, performing statistical analysis, and contributing to manuscript development.


The following link takes you to *Effect of Temperature and Atmosphere on the Optical, Thermal, and Structural Properties of Fly Ash Particles*, published in the journal *Powder Technology*.
